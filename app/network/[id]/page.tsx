...
export default function NetworkDetailsPage() {
  ...
  const renderAgentIcon = (agent: Agent) => {
    ...
    return (
      <div
        className={`w-10 h-10 rounded-full ${color.replace(
          "text-",
          "bg-"
        )}/10 flex items-center justify-center border border-${color.replace(
          "text-",
          ""
        )}/20`}
      >
            ...
            <div className="feature-card">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-sm text-foreground/70">
                  {networkAgents.length} agent
                  {networkAgents.length !== 1 ? "s" : ""}
                </div>
              </div>
              ...
              <div className="relative h-[300px] bg-background/50 rounded-lg overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-full h-full">
                    ...
                    {networkAgents.map(
                      ({ agent_id, role, agents: agent }, index) => {
                        // Calculate position in a circle around the center
                        const angle =
                          (index / networkAgents.length) * Math.PI * 2;
                        ...
                        let Icon = Brain;
                        if (agent.type?.toLowerCase().includes("data"))
                          Icon = Database;
                        else if (agent.type?.toLowerCase().includes("code"))
                          Icon = Cpu;
                        else if (agent.type?.toLowerCase().includes("creative"))
                          Icon = Sparkles;
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              className="absolute top-1/2 left-1/2 w-[100px] h-0.5 bg-gradient-to-r from-primary/10 to-primary/50 origin-left"
                              style={{
                            ...
                            {/* Agent icon */}
                            <div
                              className={`w-12 h-12 rounded-full ${color.replace(
                                "text-",
                                "bg-"
                              )}/10 flex items-center justify-center border border-${color.replace(
                                "text-",
          ...
          <div className="space-y-6">
            <div className="feature-card">
              ...
              <p className="text-foreground/70 mb-6">
                Transform your content strategy with our advanced multi-agent
                content generation system. This network-powered engine will
                leverage the unique capabilities of each agent in your network
                to create sophisticated, multi-modal content across various
                formats.
              </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-foreground/70 mt-1">
                        Automatically create text, code, images, audio, and
                        video content from a single prompt, with each agent
                        handling its specialized domain.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-foreground/70 mt-1">
                        Set up automated publishing schedules across multiple
                        platforms with smart timing optimization.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-foreground/70 mt-1">
                        Design sophisticated content pipelines with
                        agent-specific tasks, review stages, and approval
                        processes.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-foreground/70 mt-1">
                        Track content performance and automatically refine
                        generation parameters based on audience engagement.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-background/50 p-5 rounded-lg mb-6 border border-dashed border-primary/30">
                ...
                <p className="text-sm text-foreground/70 mb-4">
                  The Automated Content Engine analyzes your network&lsquo;s
                  agent composition and capabilities to create an intelligent
                  content generation pipeline. Each agent contributes its
                ...
                <div className="space-y-3 mb-4">
                  {networkAgents.map(({ agent_id, role, agents: agent }) => (
                    <div
                      key={agent_id}
                      className="flex items-start gap-3 bg-background/30 p-3 rounded-md"
                    >
                      {renderAgentIcon(agent)}
                      <div>
                        ...
                        <p className="text-xs text-foreground/70 mt-1">
                          {role === "processor" &&
                            "Processes and structures raw content data"}
                          {role === "analyzer" &&
                            "Analyzes content for quality and relevance"}
                          {role === "creator" &&
                            "Generates creative content elements"}
                          {role === "validator" &&
                            "Ensures content accuracy and compliance"}
                          {role === "primary" &&
                          ...
                          {![
                            ...
                            } capabilities to the content pipeline`}
                        </p>
                      </div>
                    </div>
                  ))}
        ...
        return (
          <div className="space-y-6">
            <div className="feature-card">
              ...
              <p className="text-foreground/70 mb-6">
                Integrate this network into your applications using our
                JavaScript/TypeScript SDK. This feature is currently in
              ...
              <div className="bg-background/50 p-4 rounded-lg border border-border">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      copyToClipboard("npm install @agent-mint/sdk", "sdk")
                    }
                  >
                    {copiedSDK ? (
              ...
              <div className="bg-background/50 p-4 rounded-lg border border-border mt-4">
                ...
                <pre className="bg-background p-3 rounded text-sm overflow-x-auto">
                  {`import { AgentMint } from '@agent-mint/sdk';

// Initialize the SDK
const agentMint = new AgentMint({
  apiKey: 'YOUR_API_KEY'
});

// Use the network
const response = await AgentMint.networks.prompt('${networkId}', {
        ...
        return (
          <div className="space-y-6">
            <div className="feature-card">
              ...
              <p className="text-foreground/70 mb-6">
                Integrate this network directly into your applications using our
                REST API. This feature is currently in development and will be
                available soon.
              </p>
              ...
              <div className="bg-background/50 p-4 rounded-lg border border-border">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      copyToClipboard(
                        `https://api.agentmint.ai/v1/networks/${networkId}/prompt`,
                        "api"
                      )
                    }
                  >
              ...
              <div className="bg-background/50 p-4 rounded-lg border border-border mt-4">
                ...
                <pre className="bg-background p-3 rounded text-sm overflow-x-auto">
                  {`// POST https://api.agentmint.ai/v1/networks/${networkId}/prompt
{
  "prompt": "Your prompt here",
  "options": {
    "temperature": 0.7,
    ...
    return (
      <div className="min-h-screen bg-background text-foreground flex items-center justify-center">
        <div className="max-w-md w-full p-6 text-center">
          ...
          <p className="text-foreground/70 mb-6">
            The network you&#39;re looking for doesn&apos;t exist or you
            don&lsquo;t have permission to view it.
          </p>
          <Link href="/network">
            <Button variant="outline" className="cursor-pointer">
              Back to Networks
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
              <div>
                ...
                <p className="text-foreground/70 max-w-xl">
                  {network.description ||
                    "A collaborative network of AI agents working together."}
                </p>
              </div>
            ...
            <div className="feature-card mb-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-foreground/70">
                    View and interact with your agent network
                  </p>
                </div>
              </div>
