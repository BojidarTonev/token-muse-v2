...
const milestones = [
  {
    ...
    description:
      "Initial platform architecture and core functionality development.",
    status: "completed",
  ...
  },
  {
    ...
    description:
      "Implementing the token economy and marketplace functionality.",
    status: "completed",
...

  {
    ...
    description:
      "Building the foundation for agent networks and collaboration.",
    status: "completed",
  ...
  },
  {
    ...
    description:
      "Implementing collaborative narrative generation capabilities.",
    status: "in-progress",
    ...
    items: [
      ...
      {
        text: "Narrative visualization and editing tools",
        status: "in-progress",
      },
    ],
  },
  ...
  },
  {
    ...
    description:
      "Expanding the platform ecosystem and third-party integrations.",
    status: "planned",
    icon: <Sparkles className="w-5 h-5" />,
    items: [
  ...
  },
  {
    ...
    description:
      "Scaling the platform globally with enhanced performance and capabilities.",
    status: "planned",
    icon: <Sparkles className="w-5 h-5" />,
    items: [
          ...
          <AnimatedElement animation="fadeIn" delay={0.1}>
            <div className="text-center mb-12">
              ...
              <p className="text-foreground/70 max-w-2xl mx-auto">
                Our journey to build the most advanced decentralized AI agent
                platform with blockchain tokenization and DAO governance.
              </p>
            </div>
          </AnimatedElement>
                ...
                <div className="flex flex-col md:flex-row gap-8 relative">
                  <div className="md:w-2/3">
                    ...
                    <p className="text-foreground/80 mb-4">
                      We&lsquo;re building a DAO to give our community direct
                      control over the platform&#39;s future. Token holders will
                      be able to propose and vote on key decisions, ensuring the
                      platform evolves according to the needs of its users.
                    </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                      <div className="bg-background/50 p-4 rounded-lg backdrop-blur-sm">
                        ...
                        <p className="text-sm text-foreground/70">
                          Token holders will be able to vote on platform
                          upgrades, feature prioritization, and treasury
                          allocations.
                        </p>
                      </div>
                      ...
                      <div className="bg-background/50 p-4 rounded-lg backdrop-blur-sm">
                        ...
                        <p className="text-sm text-foreground/70">
                          The community will be able to propose new features,
                          improvements, and partnerships through the DAO.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <ScrollReveal animation="slideUp" delay={0.2}>
              <div className="feature-card p-6 relative overflow-hidden">
                ...
                <div className="mb-6 w-full">
                  <div className="bg-primary/10 border border-primary/20 rounded-lg p-4 flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-sm text-foreground/70">
                        Community Feature Voting is currently in development and
                        will be available with our DAO governance launch in Q3
                        2025.
                      </p>
                    </div>
                  </div>
                ...
                <p className="text-foreground/70 mb-8 max-w-2xl">
                  Help shape the future of AgentMint by voting on upcoming
                  features and priorities. This preview shows how our DAO
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-8 opacity-70">
                  <ScrollReveal animation="fadeIn" delay={0.3}>
                    <div className="bg-background/50 p-5 rounded-lg border border-border/10 relative overflow-hidden">
                      ...
                      <p className="text-sm text-foreground/70 mb-4">
                        Implement advanced training capabilities for agents,
                        allowing users to fine-tune their behavior and
                        responses.
                      </p>
                  ...
                  <ScrollReveal animation="fadeIn" delay={0.4}>
                    <div className="bg-background/50 p-5 rounded-lg border border-border/10 relative overflow-hidden">
                      ...
                      <p className="text-sm text-foreground/70 mb-4">
                        Expand tokenization capabilities to support multiple
                        blockchain networks and cross-chain functionality.
                      </p>
                      <div className="w-full bg-background h-3 rounded-full mb-2 overflow-hidden">
                        <div
                          className="bg-primary h-3 rounded-full"
