          ...
          <AnimatedElement animation="fadeIn" delay={0.1}>
            <div className="text-center mb-12">
              ...
              <p className="text-foreground/70 max-w-2xl mx-auto">
                A comprehensive breakdown of the platform&#39;s token economy,
                distribution model, and utility.
              </p>
            </div>
          </AnimatedElement>
                ...
                <AnimatedElement animation="slideRight" delay={0.2}>
                  <div>
                    ...
                    <p className="text-foreground/70 mb-6">
                      ...
                      providing governance rights to holders.
                    </p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-foreground/70">
                            75% of developer tokens will be burned to reduce
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-foreground/70">
                            Team and investor tokens are subject to a 24-month
                            vesting period with a 6-month cliff.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <AnimatedElement animation="slideRight" delay={0.3}>
                    <div>
                      ...
                      <p className="text-foreground/70 mb-4 text-sm">
                        Our platform operates on a fair and transparent revenue
                        model that prioritizes our users and creators while
            ...
            <div className="feature-card p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="relative w-full h-full">
                        <svg viewBox="0 0 100 100" className="w-full h-full">
                          ...
                          />
                          <path
                            d="M50,5 A45,45 0 0,1 50,95 A45,45 0 0,1 5,50"
                            fill="transparent"
                            stroke="var(--primary)"
                            strokeWidth="10"
                          />
                ...
                <div className="order-1 md:order-2">
                  ...
                  <p className="text-foreground/70 mb-4 text-sm">
                    To enhance token value and create a deflationary mechanism,
                    we&apos;re implementing a strategic burn of 25% of the
              ...
              >
                <ScrollReveal animation="slideUp" delay={0.1}>
                  <div className="feature-card text-center">
                    ...
                    <p className="text-sm text-foreground/70">
                      Reserved for community incentives, grants, and ecosystem
                      growth.
                    </p>
                  </div>
                </ScrollReveal>
                ...
                <ScrollReveal animation="slideUp" delay={0.2}>
                  <div className="feature-card text-center">
                    ...
                    <p className="text-sm text-foreground/70">
                      Allocated to the founding team and advisors with a
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="feature-card">
                ...
                <p className="text-sm text-foreground/70">
                  Use $MINT tokens to create and customize AI agents with
                  advanced capabilities and higher output quality.
                </p>
              </div>
              ...
              <div className="feature-card">
                ...
                <p className="text-sm text-foreground/70">
                  $MINT holders can vote on platform upgrades, feature
                  prioritization, and treasury allocations.
                </p>
              </div>
              ...
              <div className="feature-card">
                ...
                <p className="text-sm text-foreground/70">
                  Stake $MINT to earn a share of platform fees generated from
                  agent licensing and marketplace transactions.
                </p>
              </div>
            </div>
          </section>
